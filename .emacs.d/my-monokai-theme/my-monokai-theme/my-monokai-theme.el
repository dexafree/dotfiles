;;; my-monokai.el --- A fruity color theme for Emacs.

;; Copyright (C) 2011-2013

;; Author: Kelvin Smith <oneKelvinSmith@gmail.com>
;; URL: http://github.com/oneKelvinSmith/my-monokai-emacs
...
;;; Commentary:
;;
;; A port of the popular Textmate theme my-monokai for Emacs 24, built on top
;; of the new built-in theme support in Emacs 24.
;;
;;; Credits:
;;
;; Wimer Hazenberg created the original theme.
;; - http://www.my-monokai.nl/blog/2006/07/15/textmate-color-theme/
;;
...
;;
;; K. Adam Christensen for his personal my-monokai theme that addresses 256 colours.
;; - https://github.com/pope/personal/blob/master/etc/emacs.d/my-monokai.el
;;
...
(unless (>= emacs-major-version 24)
  (error "The my-monokai theme requires Emacs 24 or later!"))

(deftheme my-monokai "The my-monokai colour theme")

(defgroup my-monokai nil
  "my-monokai theme options.
...
(defcustom my-monokai-use-variable-pitch t
  "Use variable pitch face for some headings and titles."
  :type 'boolean
  :group 'my-monokai)

(defcustom my-monokai-high-contrast-mode-line nil
  "Make the active/inactive mode line stand out more."
  :type 'boolean
  :group 'my-monokai)

(defcustom my-monokai-height-minus-1 0.8
  "Font size -1."
  :type 'number
  :group 'my-monokai)

(defcustom my-monokai-height-plus-1 1.1
  "Font size +1."
  :type 'number
  :group 'my-monokai)

(defcustom my-monokai-height-plus-2 1.15
  "Font size +2."
  :type 'number
  :group 'my-monokai)

(defcustom my-monokai-height-plus-3 1.2
  "Font size +3."
  :type 'number
  :group 'my-monokai)

(defcustom my-monokai-height-plus-4 1.3
  "Font size +4."
  :type 'number
  :group 'my-monokai)
...
(let* ((class                    '((class color) (min-colors 257)))
       ...
       (my-monokai-hl-line          "#3E3D31")
       (my-monokai-hl               "#49483E")
       (my-monokai-emph             "#F8F8F0")
       (my-monokai-comments         "#75715E")
       ;; Adaptive higher/lower contrast accented colors
       (my-monokai-fg-hc            "#141414")
       (my-monokai-fg-lc            "#171A0B")
       ...
       (s-mode-line-fg           (if my-monokai-high-contrast-mode-line
                                     my-monokai-bg my-monokai-fg))
       (s-mode-line-bg           (if my-monokai-high-contrast-mode-line
                                     my-monokai-fg my-monokai-hl-line))
       (s-mode-line-buffer-id-fg (if my-monokai-high-contrast-mode-line
                                     'unspecified green))
       (s-mode-line-inactive-fg  (if my-monokai-high-contrast-mode-line
                                     my-monokai-fg my-monokai-comments))
       (s-mode-line-inactive-bg  (if my-monokai-high-contrast-mode-line
                                     my-monokai-hl-line my-monokai-bg))
       (s-mode-line-inactive-bc  (if my-monokai-high-contrast-mode-line
                                     my-monokai-fg my-monokai-hl-line))
       ...
       (terminal-my-monokai-bg               "#1B1E1C")
       (terminal-my-monokai-hl-line          "#212121")
       (terminal-my-monokai-hl               "#303030")
       (terminal-my-monokai-emph             "#FFFAFA")
       (terminal-my-monokai-comments         "#8B8878")
       ;; Adaptive higher/lower contrast accented colors
       (terminal-my-monokai-fg-hc            "#171A0B")
       (terminal-my-monokai-fg-lc            "#141414")
       ;; High contrast colors
       ...
       (terminal-s-mode-line-fg           (if my-monokai-high-contrast-mode-line
                                              terminal-my-monokai-bg terminal-my-monokai-fg))
       (terminal-s-mode-line-bg           (if my-monokai-high-contrast-mode-line
                                              terminal-my-monokai-fg terminal-my-monokai-hl-line))
       (terminal-s-mode-line-buffer-id-fg (if my-monokai-high-contrast-mode-line
                                              'unspecified terminal-green))
       (terminal-s-mode-line-inactive-fg  (if my-monokai-high-contrast-mode-line
                                              terminal-my-monokai-fg terminal-my-monokai-comments))
       (terminal-s-mode-line-inactive-bg  (if my-monokai-high-contrast-mode-line
                                              terminal-my-monokai-hl-line terminal-my-monokai-bg))
       (terminal-s-mode-line-inactive-bc  (if my-monokai-high-contrast-mode-line
                                              terminal-my-monokai-fg terminal-my-monokai-hl-line)))
  ...
  (custom-theme-set-faces
   ...
   ;; basic coloring
   `(default
      ((,class (:foreground ,my-monokai-fg
                            :background ,my-monokai-bg))
       (,terminal-class (:foreground ,terminal-my-monokai-fg
                                     :background ,terminal-my-monokai-bg))))
   ...
   `(match
     ((,class (:background ,my-monokai-hl
                           :foreground ,my-monokai-emph
                           :weight bold))
      (,terminal-class (:background ,terminal-my-monokai-hl
                                    :foreground ,terminal-my-monokai-emph
                                    :weight bold))))

   `(cursor
     ((,class (:foreground ,my-monokai-bg
                           :background ,my-monokai-fg
                           :inverse-video t))
      (,terminal-class (:foreground ,terminal-my-monokai-bg
                                    :background ,terminal-my-monokai-fg
                                    :inverse-video t))))
   ...
   `(cua-global-mark
     ((,class (:background ,yellow
                           :foreground ,my-monokai-bg))
      (,terminal-class (:background ,terminal-yellow
                                    :foreground ,terminal-my-monokai-bg))))
   ...
   `(cua-rectangle-noselect
     ((,class (:inherit region
                        :background ,my-monokai-hl
                        :foreground ,my-monokai-comments))
      (,terminal-class (:inherit region
                                 :background ,terminal-my-monokai-hl
                                 :foreground ,terminal-my-monokai-comments))))
   ...
   `(ecb-source-in-directories-buffer-face
     ((,class (:inherit ecb-directories-general-face
                        :foreground ,my-monokai-fg))
      (,terminal-class (:inherit ecb-directories-general-face
                                 :foreground ,terminal-my-monokai-fg))))
   ...
   `(ecb-tree-guide-line-face
     ((,class (:inherit ecb-default-general-face
                        :foreground ,my-monokai-hl
                        :height 1.0))
      (,terminal-class (:inherit ecb-default-general-face
                                 :foreground ,terminal-my-monokai-hl
                                 :height 1.0))))

   ;; ee
   `(ee-bookmarked
     ((,class (:foreground ,my-monokai-emph))
      (,terminal-class (:foreground ,terminal-my-monokai-emph))))
   ...
   `(vertical-border
     ((,class (:foreground ,my-monokai-hl))
      (,terminal-class (:foreground ,terminal-my-monokai-hl))))
   ...
   `(font-latex-italic-face
     ((,class (:inherit italic :foreground ,my-monokai-emph))
      (,terminal-class (:inherit italic :foreground ,terminal-my-monokai-emph))))
   ...
   `(font-latex-sectioning-0-face
     ((,class (:inherit font-latex-sectioning-1-face
                        :height ,my-monokai-height-plus-1))
   ...
   `(font-latex-slide-title-face
     ((,class (:inherit (,s-variable-pitch font-lock-type-face)
                        :weight bold
                        :height ,my-monokai-height-plus-3))
   ...
   `(font-latex-subscript-face
     ((,class (:height ,my-monokai-height-minus-1))
      (,terminal-class (:height ,my-monokai-height-minus-1))))
   ...
   `(cfw:face-title
     ((,class (:inherit ,s-variable-pitch
                        :foreground ,yellow
                        :weight bold
                        :height ,my-monokai-height-plus-4))
      (,terminal-class (:inherit ,terminal-s-variable-pitch
                                 :foreground ,terminal-yellow
                                 :weight bold
                                 :height ,my-monokai-height-plus-4))))
   ...
   `(ctbl:face-cell-select
     ((,class (:background ,my-monokai-hl
                           :foreground ,my-monokai-emph
                           :underline ,my-monokai-emph
                           :weight bold))
      (,terminal-class (:background ,terminal-my-monokai-hl
                                    :foreground ,terminal-my-monokai-emph
                                    :underline ,terminal-my-monokai-emph
                                    :weight bold))))
   ...
   `(diff-header
     ((,class (:background ,my-monokai-bg))
      (,terminal-class (:background ,terminal-my-monokai-bg))))
   ...
   `(ediff-even-diff-A
     ((,class (:background ,my-monokai-comments
                           :foreground ,my-monokai-fg-lc ))
      (,terminal-class (:background ,terminal-my-monokai-comments
                                    :foreground ,terminal-my-monokai-fg-lc ))))

   `(ediff-odd-diff-A
     ((,class (:background ,my-monokai-comments
                           :foreground ,my-monokai-fg-hc ))
      (,terminal-class (:background ,terminal-my-monokai-comments
                                    :foreground ,terminal-my-monokai-fg-hc ))))
   ...
   `(gnus-x-face
     ((,class (:background ,my-monokai-fg
                           :foreground ,my-monokai-bg))
      (,terminal-class (:background ,terminal-my-monokai-fg
                                    :foreground ,terminal-my-monokai-bg))))
   ...
   ;; hl-line-mode
   `(hl-line
     ((,class (:background ,my-monokai-hl-line
                           :inherit t))
      (,terminal-class (:background ,terminal-my-monokai-hl-line
                                    :inherit t))))
   ...
   `(markdown-header-face-3
     ((,class (:inherit markdown-header-face
                        :height ,my-monokai-height-plus-2))
      (,terminal-class (:inherit markdown-header-face
                                 :height ,my-monokai-height-plus-2))))
   ...
   `(org-agenda-structure
     ((,class (:foreground ,my-monokai-emph
                           ...
                           :height ,my-monokai-height-plus-1
                           :underline nil
                           :box (:line-width 2 :color ,my-monokai-bg)))
      (,terminal-class (:foreground ,terminal-my-monokai-emph
                                    :background ,terminal-my-monokai-hl
                                    :weight bold
                                    :slant normal
                                    ...
                                    :height ,my-monokai-height-plus-1
                                    :underline nil
                                    :box (:line-width 2 :color ,terminal-my-monokai-bg)))))
   ...
   `(org-agenda-date
     ((,class (:foreground ,my-monokai-comments
      ...
      (,terminal-class (:foreground ,terminal-my-monokai-comments
                                    ...
                                    :slant normal
                                    :height 1.0
                                    :box (:line-width 2 :color ,terminal-my-monokai-bg)))) t)
   ...
   `(org-agenda-date-today
     ((,class (:inherit org-agenda-date
      ...
      (,terminal-class (:inherit org-agenda-date
                                 ...
                                 :box unspecified
                                 :foreground ,terminal-blue
                                 :background ,terminal-my-monokai-bg))) t)
   ...
   ;; parenface
   `(paren-face
     ((,terminal-class (:foreground ,my-monokai-comments))))
   ...
   `(popup-scroll-bar-foreground-face
     ((,class (:background ,my-monokai-emph))
      (,terminal-class (:background ,terminal-my-monokai-emph))))
   ...
   `(yascroll:thumb-text-area
     ((,class (:foreground ,my-monokai-comments
                           :background ,my-monokai-comments))
      (,terminal-class (:foreground ,terminal-my-monokai-comments
                                    :background ,terminal-my-monokai-comments))))
   ...
   `(zencoding-preview-input
     ((,class (:background ,my-monokai-hl
                           :box ,my-monokai-emph))
      (,terminal-class (:background ,terminal-my-monokai-hl
                                    :box ,terminal-my-monokai-emph)))))

  (custom-theme-set-variables
   'my-monokai
   `(ansi-color-names-vector [,my-monokai-bg ,red ,green ,yellow
                                          ,blue ,magenta ,cyan ,my-monokai-fg])

   ;; compilation
   `(compilation-message-face 'default)

   ;; fill-column-indicator
   `(fci-rule-color ,my-monokai-hl)
   ...
   `(highlight-tail-colors
     '((,my-monokai-hl . 0)(,green-lc . 20)(,cyan-lc . 30)(,blue-lc . 50)
       (,yellow-lc . 60)(,orange-lc . 70)(,magenta-lc . 85)(,my-monokai-hl . 100)))
   ...
   ;; weechat
   `(weechat-color-list
     (unspecified ,my-monokai-bg ,my-monokai-hl
                  ,red-d ,red
                  ,green-d ,green
                  ,yellow-d ,yellow
                  ,blue-d ,blue
